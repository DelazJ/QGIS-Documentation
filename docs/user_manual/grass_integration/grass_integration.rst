...
QGIS provides access to GRASS GIS databases and functionalities.
This integration consists of allowing to browse, manage and visualize GRASS raster
and vector layers. It also includes ability to create new GRASS projects and mapsets,
change GRASS region, create and edit vector layers and analyze GRASS 2D and 3D data.
Along with the above features accessible from the :guilabel:`Browser Panel`,
you can use additional geoprocessing tools by activating
...
.. Supported GRASS version may vary depending on your Operating System.
...
With GRASS installed, browsing the :guilabel:`Browser panel`,
you'll find the |grassLogo| GRASS icon under each folder item
which contains a GRASS project.
...
#. To import the vector GML file :file:`lakes.gml`, click the module
   ...
   you to import OGR-supported vector files into a GRASS :file:`PROJECT`. The
