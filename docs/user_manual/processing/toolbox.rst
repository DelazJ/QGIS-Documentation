...
* A **coordinate reference system**. You can select it among the recently used
  ...
  .. tip:: **Drag-and-drop as convenient shortcut for CRS selection**

     You can also drag a layer from the Layers panel and drop it onto the CRS widget.
     The widget will automatically set its CRS to match the dropped layer's.
