...
.. list-table::
   ...
   * - **Use 8-connectedness**
     ...
     - [boolean]
       ...
       Default: False
     - If false, consider as neighbours the pixels that connect the edges, horizontally and vertically.
       If true, every pixel that touches one of the edges or corners is considered as neighbour.
