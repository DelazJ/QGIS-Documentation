...
Due to the inconsistency in the definition of the Right-Hand-Rule in some contexts,
it is recommended to use the explicit :ref:`qgisforcecw` algorithm instead.
