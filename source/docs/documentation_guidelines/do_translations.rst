...
QGIS translation process is managed thanks to the **Transifex web platform**.
Transifex transparently does the process described above and pulls all the translatable
texts in one place for the translator. The remaining tasks for translators
are to select the file of their choice and translate it.
...
You get a list of all translatable :file:`.po` files. Click on the file you
are interested in translating and choose ``Translate`` in the prompted dialog.
